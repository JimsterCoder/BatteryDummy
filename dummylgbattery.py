...
PID_INVERTER_HANDSHAKE_REQ  = 0x560 #from inverter
...
msg = cSendMsg( 0x4D8, [0x00, 0x16, 0x00, 0x00, 0x00, 0xA1, 0x02, 0x00], 5000, 0)
sendmsg.append(msg)

msg = cSendMsg( 0x358, [0x13, 0x56, 0x10, 0xFE, 0x00, 0xA2, 0x00, 0xA2], 1000, 0)
sendmsg.append(msg)

msg = cSendMsg( 0x3D8, [0x1A, 0xB1, 0x27, 0x10, 0xFF, 0xFF, 0xFF, 0xFF], 5000, 0)
sendmsg.append(msg)

msg = cSendMsg( 0x158, [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], 5000, 0)
sendmsg.append(msg)

msg = cSendMsg( 0x198, [0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF], 5000, 0)
sendmsg.append(msg)

msg = cSendMsg( 0x218, [0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF], 5000, 0)
sendmsg.append(msg)

# LIST OF MESSAGES TO SEND IN RESPONSE TO 0x560
rspmsg = []
